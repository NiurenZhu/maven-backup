...
echo --开始部署
CALL :DEPLOY_PACKAGE com.sap.b1 sbowrapper 10 %WORK_FOLDER%\sbowrapper.jar maven-3rdparty
CALL :DEPLOY_PACKAGE com.sap.b1 sboapi 10 %WORK_FOLDER%\sboapi.jar maven-3rdparty
